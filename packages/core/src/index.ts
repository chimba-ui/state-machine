...
// The authoring entry point. `setup.infer().createMachine(literal)` for a quick config
// (types inferred, names loose); `setup.as<Ctx,Ev>().config(registries).createMachine(...)`
